...
/*#__PURE__*/
function () {
  function CanvasEagle(elm) {
    _classCallCheck(this, CanvasEagle);

    this.paintCanvas = document.querySelector(elm);
    this.paintContext = this.paintCanvas.getContext('2d');
    this.drawCanvas = document.createElement('canvas');
    this.drawCtx = this.drawCanvas.getContext('2d'); // this.paintContext.imageSmoothingEnabled = false;
    ...
    this.debug = true;
    this.initListener(); // this.createGrid();
  }

  _createClass(CanvasEagle, [{
    key: "log",
    value: function log(message) {
      if (this.debug) console.log(JSON.stringify(message));
    }
  }, {
    key: "setDrawer",
    ...
    value: function initListener() {
      ...
      this.paintCanvas.addEventListener("mousemove", function (e) {
        _this.findxy('move', e);
      }, false);
      this.paintCanvas.addEventListener("mousedown", function (e) {
        _this.findxy('down', e);
      }, false);
      this.paintCanvas.addEventListener("mouseup", function (e) {
        _this.findxy('up', e);
      }, false);
      this.paintCanvas.addEventListener("mouseout", function (e) {
        _this.findxy('out', e);
      }, false);
    }
  }, {
    ...
    key: "updatePaintCanvas",
    value: function updatePaintCanvas() {
      this.paintContext.clearRect(0, 0, this.paintContext.canvas.width, this.paintContext.canvas.height);
      ...
      this.paintContext.drawImage(this.drawCanvas, -this.drawer.width * 0.5, -this.drawer.height * 0.5);
    ...
    value: function draw() {
      if (this.drawer.flag) {
        this.paintCanvas.dispatchEvent(new CustomEvent('draw', {
          detail: this.drawer
        })); //this.context.beginPath();
    ...
    key: "drawing",
    value: function drawing(drawer) {
      if (drawer.tool === 'eraser') {
        //this.context.globalCompositeOperation = "destination-out";
        var x = drawer.pos.x;
        var y = drawer.pos.y;
        var radius = drawer.lineWidth;
        this.context.beginPath();
    ...
    key: "drawRemote",
    value: function drawRemote(drawer) {
      console.log('drawe');
      this.context.beginPath();
    ...
    value: function createGrid() {
      var tileSize = 24;
      var t = this.drawCanvas.width / tileSize; // how big the grid is on each side, number of tiles
    ...
    key: "setBigger",
    value: function setBigger() {
      this.drawer.lineWidth += 1;
      return this;
    }
  }, {
    key: "setSmaller",
    value: function setSmaller() {
      this.drawer.lineWidth -= 1;
      return this;
    }
  }, {
    key: "setZoomIn",
    value: function setZoomIn(e) {
      e.preventDefault();
...
(function () {
  var canvas = document.getElementById('drawing'),
      context = canvas.getContext('2d'); // resize the canvas to fill browser window dynamically
  ...
  function drawStuff() {// do your drawing stuff here
  }
})();
